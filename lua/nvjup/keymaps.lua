...
function M.attach(buf)
	...
	map(buf, "n", keys.plot_focus, actions.plot_focus, "Open interactive output in Awrit")
	map(buf, "n", keys.plot_focus_tui, actions.plot_focus_tui, "Open interactive output in TUI focus")
	...
	map(buf, "n", keys.variables, actions.variables, "Kernel variable inspector")
	map(buf, "n", keys.remote_connection, actions.remote_connection, "Connect/manage remote Jupyter Server")
	map(buf, "n", keys.remote_files, actions.remote_files, "Local/remote Jupyter file manager")
